...
<head>
  ...
  <title>IA Decorate - Editar Usuario</title>
...
<body>
  ...
  <main class="main-content">
    ...
    <div class="crud-container">
      <h5 class="crud-title">Editar Usuario</h5>
      ...
      <form action="{{ route('admin.usuarios.update', $usuario) }}" method="POST">
        ...
        <div class="row">
          <div class="col-md-6 mb-3">
            ...
            <div class="password-note">Dejar en blanco para no cambiar</div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="date" class="form-control" id="fecha_nacimiento" name="fecha_nacimiento" value="{{ old('fecha_nacimiento', $usuario->fecha_nacimiento ?? '') }}">
          </div>
        </div>

        <div class="mb-3">
          <label for="direccion" class="form-label">Dirección</label>
          <input type="text" class="form-control" id="direccion" name="direccion" value="{{ old('direccion', $usuario->direccion) }}">
        </div>

        <div class="row">
          <div class="col-md-6 mb-3">
            <label for="ciudad" class="form-label">Ciudad</label>
            <input type="text" class="form-control" id="ciudad" name="ciudad" value="{{ old('ciudad', $usuario->ciudad) }}">
          </div>

          <div class="col-md-6 mb-3">
            <label for="codigo_postal" class="form-label">Código Postal</label>
            <input type="text" class="form-control" id="codigo_postal" name="codigo_postal" value="{{ old('codigo_postal', $usuario->codigo_postal) }}">
          </div>
        </div>
          ...
          <div class="checkbox-roles">
            ...
            <div class="checkbox-item">
              <input type="checkbox" id="rol_{{ $rol->id }}" name="roles[]" value="{{ $rol->id }}"
                {{ $usuario->roles->contains($rol->id) || in_array($rol->id, old('roles', [])) ? 'checked' : '' }}>
